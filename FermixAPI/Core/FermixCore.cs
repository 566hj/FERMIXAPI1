...
using FermixLoader = FermixAPI.Loader;
...
namespace FermixAPI.Core
{
    ...
    public static class FermixCore
    {
        ...
        /// </summary>
        public static FermixLoader PluginInstance { get; private set; }
        ...
        public static void Initialize(FermixLoader plugin)
        {
            if (IsInitialized)
            {
            ...
            try
            {
                ...
                Modules.FermixInput.Initialize();
                Modules.FermixGlow.Initialize();
        ...
        public static void Shutdown()
        {
            ...
            try
            {
                ...
                Modules.FermixGlow.Shutdown();
                Modules.FermixInput.Shutdown();
